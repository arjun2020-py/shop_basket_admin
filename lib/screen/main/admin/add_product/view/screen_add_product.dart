              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: cubit.productNamectr,
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: TextFormField(
                      controller: cubit.shortDecrptionctr,
                      maxLines: 4,
                      decoration: InputDecoration(
                  ...
                  Padding(
                    padding: const EdgeInsets.all(10.0),
                    child: TextFormField(
                      controller: cubit.productPricectr,
                      decoration: InputDecoration(
                          enabledBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(10)),
                          focusedBorder: OutlineInputBorder(
                  ...
                  Center(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () {
                            cubit.storeDataToFirestore(
                                cubit.productNamectr.text,
                                cubit.shortDecrptionctr.text,
                                cubit.dropdownValue,
                                cubit.productPricectr.text,
                                cubit.imageUrl);
                          },
                          child:cubit.isLoading ?CircularProgressIndicator(): CustomText(
                              text: 'Publish',
                              color: blackColor,
                              fontSize: 18,
                              fontWeight: FontWeight.w400)),
